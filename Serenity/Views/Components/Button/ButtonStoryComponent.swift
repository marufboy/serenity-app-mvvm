...
struct ButtonStoryComponent_Previews: PreviewProvider {
    static var previews: some View {
        ButtonStoryComponent(title: "Magic Self talk", subtitle: "Calmness is within your reach. Let me show you through a moment of reflection." ,imageName: "moon.haze.fill", widthImage: 800, heightImage: 800)
    }
}
